...
ventas.to_csv('datasets/ventas.csv', index=False, na_rep='NA')
clientes.to_csv('datasets/clientes.csv', index=False, na_rep='NA')
productos.to_csv('datasets/productos.csv', index=False, na_rep='NA')
